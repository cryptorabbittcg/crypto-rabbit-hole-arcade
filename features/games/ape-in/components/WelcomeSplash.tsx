          ...
          <div className="relative flex justify-center items-center h-80 w-[600px]">
            ...
            >
              <div className="relative">
                <motion.img
                  src="/features/games/ape-in/assets/images/cards/Ape_In_Historic.jpg"
            ...
            >
              <div className="relative">
                <motion.img
                  src="/features/games/ape-in/assets/images/cards/Ape_In.jpg"
                  alt="Ape In Card"
            ...
            >
              <div className="relative">
                <motion.img
                  src="/features/games/ape-in/assets/images/cards/Ape_In_MAYC.jpg"
