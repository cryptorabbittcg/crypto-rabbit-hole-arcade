...
-- =====================================================
-- This migration creates the cryptoku_leaderboard table
-- and associated functions if they don't already exist.
-- Based on scripts/09-create-cryptoku-leaderboard-table.sql
-- =====================================================
...
-- DROP FUNCTION IF EXISTS add_cryptoku_leaderboard_entry(TEXT, UUID, TEXT, INTEGER, INTEGER, INTEGER, INTEGER, BOOLEAN, BOOLEAN);
-- DROP TABLE IF EXISTS cryptoku_leaderboard;
--
-- NOTE: Rolling back is NOT RECOMMENDED as this will break
--       Cryptoku game completion and leaderboard functionality.
-- =====================================================
