-- =====================================================
-- FIX ALL SCHEMA QUALIFICATION ISSUES
-- =====================================================
-- Recreate all functions with explicit public. schema
-- =====================================================
...
-- =====================================================
-- Recreate with explicit schema for all table references
...
SELECT 
  ...
  CASE 
    WHEN pg_get_functiondef(p.oid) LIKE '%public.profiles%' 
      OR pg_get_functiondef(p.oid) LIKE '%public.cryptoku_hints%'
      OR pg_get_functiondef(p.oid) LIKE '%public.leaderboard%'
      OR pg_get_functiondef(p.oid) LIKE '%public.cryptoku_leaderboard%'
      OR pg_get_functiondef(p.oid) LIKE '%public.transactions%'
    THEN '✅ Uses explicit schema'
